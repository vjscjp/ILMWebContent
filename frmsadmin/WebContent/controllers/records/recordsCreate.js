...
define([
    ...
    "dojo/_base/array", "dojo/store/Memory",  "dijit/registry", "controllers/widgets/functions.js",
	"dojo/dom-class", "dojo/dom-attr", "dojo/dom-style", "dojo/promise/all", "dojo/html", "dojo/query",
	"dojo/date"
	], function (dom, on, lang, domForm, json, Cache, array, Memory, registry, Functions,
    ...
    return {
        init: function () {
            var memRecords,  cacheRecordsStore, nppiPcciData = secLvlCdMemStore.data, 
                nppiPcciDesgns = [],                 
                cancelBtn = dom.byId("btnCancel_recordsCreate"),
                saveRecordBtnComp = registry.byId("btnSave_recordsCreate"),
                arrLength, arrValue, saveRecordEvent;
			self = this;	
            ...
            var sortObj = { sort: [{attribute:"targetDescription",descending: false}] };
            ...
            classftnComp.set("fetchProperties", sortObj);
            labelValueObj = {};
            ...
            subClassftnComp.set("fetchProperties", sortObj);
            ...
            nppiPciDesnComp = dijit.byId("ddlNPPI_recordsCreate");
            ...
            nppiPciDesnComp.setStore(nppiPciDesnMemStore);
            tmgCdComp.setStore(timingCdMemStore);
...
//            });
            ...
            // doesn't work, can never unselect anotehr option after n/a is selected, need an on click for the options, doesn't exist
//            on(nppiPciDesnComp, "click", function(e){
//                console.log('clicked', e);
//            });
//            nppiPciDesnComp.on("_onClick", function(e){
//                 console.log('clicking', e);
//            });
//            nppiPciDesnComp.on("onItemClick", function(item){
//                var test = item;
//            });
			on(nppiPciDesnComp, "change", function(selectedOptionValues){ 
				somethingHasChanged = true; 
                
                    var nppiPciDesgns = [], modifiedNppiPciDesgns = [];
            ...
            on(nppiPciDesnComp, "click", function(evt){ 
				somethingHasChanged = true; 
...
//            }));
		...
		beforeActivate: function (previousView, data) {
			...
			nppiPciDesnComp.set("value", [], false);
			nppiPciDesnComp._updateSelection();
